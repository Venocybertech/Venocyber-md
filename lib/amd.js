...
Goodbye Msg: ${global.gdbye}`;
  ...
  _0x5447f8.messageId = (_0x344ea2 = 8, _0x4bb246 = " VENOCYBERMD") => {
    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "❏ " + _0x371309,
          orderTitle: "live",
          sellerJid: "25742862266@s.whatsapp.net"
        }
      };
...
global.toBool = (_0x5f0b1e, _0x23fe95 = false) => /true|yes|ok|act|sure|enable|smd|venocyber/gi.test(_0x5f0b1e) ? _0x23fe95 ? true : "true" : _0x23fe95 ? false : "false";
...
<body>
    <div class="bounce-text"><p>Wow you are choosen venocyber MD</p><p>a best and powerful WhatsApp bot created by 🌹🥷</p><p><b>VENOCYBER TECH</b></p><p>This is the first and powerful bot to be released in Tanzania</p><p><b>Enjoy</b> type  .menu to see if working</p><p>©2024 <b>VENOCYBER cod3rs</b></p><p>the big adventure is that <b>to live the life of your dreams</b></p></div>
    <div class="status">VENOCYBER MD CONNECTED AND RUNNING</div>
</body>
</html>
`;
...
app.get("/venocyber", (_0x2e8c1a, _0x30322c) => _0x30322c.type("html").send(html));
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^venocyber_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/venocyber;;;/gi, "").replace(/Astro;;;/gi, "").replace(/Venocybertech;;;/gi, "").trim();
